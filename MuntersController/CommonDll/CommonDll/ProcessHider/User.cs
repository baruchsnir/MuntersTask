...
namespace FT.CommonDll
{
	...
	public class User
	{
		...
		[DllImport("user32")] public static extern int EnumChildWindows(HWND hwndParent, Delegate lpEnumFunc,ref HWND lParam);
        ...
        [DllImport("user32")] public static extern int FindWindowEx(HWND hwnd1, HWND hwnd2, string lpsz1, HWND lpsz2);
	...
	//	[DllImport("user32")] public static extern int GetClassName(HWND hwnd, string lpClassName, int nMaxCount);
		...
		//[DllImport("user32")] public static extern int GetDlgItemText(HANDLE hDlg, int nIDDlgItem, string lpString, int nMaxCount);
		[DllImport("user32", EntryPoint = "GetDlgItemText")]
		public static extern int GetDlgItemTextA(int hDlg, int nIDDlgItem, string lpString, int nMaxCount);  
...
//		[DllImport("user32")] public static extern int GetWindowText(HWND hwnd, StringBuilder lpString, int cch);
		...
		[DllImport("user32.dll")]
		public static extern int InvalidateRectA(IntPtr hWnd, IntPtr lpRect, int bErase);
		...
		[DllImport("user32.dll")]
		public static extern int RedrawWindowA(IntPtr hWnd, IntPtr lprcUpdate, IntPtr hrgnUpdate, uint flags);
		...
		[DllImport("user32")] public static extern int SendMessageA(HWND hwnd, int wMsg, int wParam, IntPtr lParam);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]public static extern int SendMessageA(IntPtr hwnd, int wMsg, int wParam,int lParam);
		...
		[DllImport("user32")] public static extern int SetWindowsHookEx(int idHook, Delegate lpfn, HANDLE hmod, int dwThreadId);
		...
		public const int APPCLASS_MASK = 0x15;
		...
		public const int DM_GETSTATE = WM_USER + 2;
		public const int DM_SETSTATE = WM_USER + 3;
		public const int DM_SETSTYLE= WM_USER + 4; 
