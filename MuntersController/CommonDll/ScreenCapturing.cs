...
namespace CodeReflection.ScreenCapturingDemo
{
	...
	public class ScreenCapturing
	{
		...
		/// Gets a Bitmap of the window (aka. screen capture)
		/// </summary>
        public static Bitmap GetWindowCaptureAsBitmap(IntPtr hWnd)
        {
        ...
        #region Refresh the button
        private static void Refresh(IntPtr h_Wnd)
        {
            Rect rect = new Rect();
            Win32.GetWindowRect(h_Wnd, ref rect);
            Win32.InvalidateRect(h_Wnd, ref rect, 0);
            Win32.UpdateWindow(h_Wnd);
		...
		/// <param name="hWnd"></param>
		/// <returns></returns>
		public static byte[] GetWindowCaptureAsByteArray(IntPtr handle)
		{
